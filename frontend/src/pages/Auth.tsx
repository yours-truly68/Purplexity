        ...
        <div className="space-y-4">
          ...
          >
            {loading === "google" ? (
              ...
              <svg
                className="w-5 h-5 mr-3 text-white transition-transform group-hover:scale-105"
                viewBox="0 0 24 24"
                fill="currentColor"
              >
                <path
          ...
          >
            {loading === "github" ? (
              ...
              <svg
                className="w-5 h-5 mr-3 fill-current transition-transform group-hover:scale-105"
                viewBox="0 0 24 24"
              >
                <path
                  fillRule="evenodd"
